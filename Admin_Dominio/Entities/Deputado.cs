namespace Projeto_desafio_API_Admin.Entities
{
    public class Deputado
    {
        ...
        public void AlterarDados(bool processo, string representante, string nome, string endereco, string telefone, string siglaPartido, string nomePartido, string projetoLei, string foto)
        {
            Processo = processo;
